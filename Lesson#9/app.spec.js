...
describe('Path variable', () => {
  ...
  // and it will still match the server url pattern
  ...
  // and we can use query parameters to change the behavior
  it("returns a user name if we have the correct url", async () => {
